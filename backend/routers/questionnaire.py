...
# Static schema — all question definitions used by the frontend to render the form
SCHEMA = {
    "sections": [
    ...
    "questions": [
        {
            ...
            "tooltip": (
                ...
                "Multiple arms are needed for tasks requiring parallel operations or accessing "
                "multiple sides of large objects."
            ),
            "type": "select",
            "options": [
        ...
        },
        {
            ...
            "title": "Camera type",
            "tooltip": (
                "Choose the type of camera system you're using. GiGE cameras are configured via "
                "the ARAVIS SDK. Select 'Other' for thermal or hyperspectral cameras."
            ),
            "type": "select",
            "options": [
            ...
            "follow_up": {
                ...
                "question": {
                    ...
                    "placeholder": "e.g., Basler acA1920-40gc, FLIR thermal camera...",
                },
            },
        },
        {
            ...
            "tooltip": (
                "Select additional sensors needed beyond vision. Tactile/force sensing "
                "helps detect surface properties through touch."
            ),
            "type": "checkbox",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Indicate if ambient lighting is sufficient for reliable vision processing, "
                "or if additional controlled lighting is required for consistent defect detection."
            ),
            "type": "select",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Select all material types you need to inspect. Different materials require "
                "specialized detection methods and training data."
            ),
            "type": "checkbox",
            "options": [
            ...
            "follow_up": {
                ...
                "question": {
                    ...
                    "placeholder": "e.g., carbon fiber, composite, ceramic...",
                },
            },
        },
        {
            ...
            "title": "Object sizes",
            "tooltip": (
                "Specify the typical size range of objects to inspect. Large objects require "
                "different planning strategies and multiple viewpoints."
            ),
            "type": "select",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Indicate whether a 3D mesh or CAD model of the object is available. "
                "Mesh availability determines whether model-based or model-free localisation is used."
            ),
            "type": "select",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Select all defect types relevant to your application. Geometric defects like "
                "dents need 3D analysis; dirt/contamination is typically detected via colour/texture."
            ),
            "type": "checkbox",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Indicate if your inspection task has time limits. "
                "Tight deadlines affect motion planning strategies and problem formulation."
            ),
            "type": "select",
            "options": [
        ...
        },
        {
            ...
            "tooltip": (
                "Choose how to prioritize inspection areas. Standard profit uses built-in "
                "heuristics. Custom criteria let you define priorities based on defect types, "
                "surface importance, or business rules."
            ),
            "type": "select",
            "options": [
